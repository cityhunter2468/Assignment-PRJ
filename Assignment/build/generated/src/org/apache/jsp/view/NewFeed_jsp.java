...
public final class NewFeed_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <script>\n");
      out.write("                                var _throttleTimer = null;\n");
      out.write("                                var _throttleDelay = 100;\n");
      out.write("                                var $window = $(window);\n");
      out.write("                                var $document = $(document);\n");
      out.write("\n");
      out.write("                                $document.ready(function () {\n");
      out.write("\n");
      out.write("                                    $window\n");
      out.write("                                            .off('scroll', ScrollHandler)\n");
      out.write("                                            .on('scroll', ScrollHandler);\n");
      out.write("\n");
      out.write("                                });\n");
      out.write("\n");
      out.write("//                                function ScrollHandler(e) {\n");
      out.write("//                                    //throttle event:\n");
      out.write("//                                    clearTimeout(_throttleTimer);\n");
      out.write("//                                    _throttleTimer = setTimeout(function () {\n");
      out.write("//                                        console.log('scroll');\n");
      out.write("//\n");
      out.write("//                                        //do work\n");
      out.write("//                                        if ($window.scrollTop() + $window.height() > $document.height() - 100) {\n");
      out.write("//                                            //alert(\"bottom\");\n");
      out.write("//                                            var amount = document.getElementsByClassName(\"sub_content\").length;\n");
      out.write("//                                            $.ajax({\n");
      out.write("//                                                url: \"/Assignment/LoadMoreNewFeed\",\n");
      out.write("//                                                type: \"post\", //send it through get method\n");
      out.write("//                                                data: {\n");
      out.write("//                                                    exits: amount\n");
      out.write("//                                                },\n");
      out.write("//                                                success: function (data) {\n");
      out.write("//                                                    //alert(\"da lay dc data\");\n");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                        <div class=\"status-field-container write-post-container sub_content\">\n");
          ...
          if (_jspx_meth_c_choose_0((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write("alt=\"Admin\" class=\"rounded-circle\" width=\"35\" height=\"35\">\n");
          out.write("\n");
          out.write("                                    <div>\n");
          out.write("                                        <p> <a href=\"profile/view?id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.ac.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.ac.displayname}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</a></p>\n");
          out.write("                                        <small>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.time_create}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</small>\n");
          out.write("                                    </div>\n");
          out.write("                                </div>\n");
          out.write("                                <div>\n");
          ...
          out.write("                                    <div onclick=\"heart()\"><i class=\"bi bi-heart\"></i>Like ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.countlike}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write(" </div>\n");
          out.write("                                    <div ><i class=\"bi bi-chat-left\"></i> Comment </div>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
          out.write("                            <div id=\"loadmorecomment\" onclick=\"comment(");
          ...
          out.write(")\">Load more comment</div>\n");
          ...
          out.write("\n");
          out.write("                            </div>\n");
          out.write("                            <div clasc=\"post_comment\">\n");
          out.write("                                <div class=\"row\">\n");
          out.write("                                    <div class=\"col-sm-1\"><img ");
          if (_jspx_meth_c_choose_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write("alt=\"Admin\" class=\"rounded-circle\" width=\"40\" height=\"40\"></div>\n");
          out.write("                                    <div class=\"col-sm-10\"><input type=\"text\" class=\"form-control\" placeholder=\"Your Comment Here\"></div>\n");
          out.write("                                </div>\n");
          out.write("                                <div class=\"row button_post\">\n");
          out.write("                                    <div class=\"col-sm-5\"></div>\n");
          out.write("                                    <div class=\"col-sm-2\"><button type=\"button\" class=\"btn btn-primary\">Post</button></div>\n");
          out.write("                                </div>\n");
          out.write("                            </div>\n");
          out.write("                        </div>\n");
          out.write("                    ");
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.ac.url_avata != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write('/');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.ac.url_avata}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" \n");
        out.write("                                            ");
  ...
  private boolean _jspx_meth_c_when_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.url_img != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write('/');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.url_img}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" class=\"anh\" alt=\"\">\n");
        out.write("                                    ");
  ...
  private boolean _jspx_meth_c_forEach_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_forEach_1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${post.comment}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                                    <div class=\"sub_comment\">\n");
          out.write("                                        <div class=\"row\">\n");
          out.write("                                            <div class=\"col-sm-1\"><img ");
          if (_jspx_meth_c_choose_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_1, _jspx_page_context, _jspx_push_body_count_c_forEach_1))
            return true;
          out.write("alt=\"Admin\" class=\"rounded-circle\" width=\"40\" height=\"40\"> </div>\n");
          out.write("                                            <div class=\"col-sm-10\"> <a href=\"\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${comment.account.displayname}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</a> <span class=\"time_comment\"> ");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${comment.time}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</span>\n");
          out.write("                                                <p>");
  ...
  private boolean _jspx_meth_c_when_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_when_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${comment.account.url_avata != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write('/');
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${comment.account.url_avata}", java.lang.String.class, (PageContext)_jspx_page_context, null));
        out.write("\" \n");
        out.write("                                                        ");
  ...
  private boolean _jspx_meth_c_when_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_3, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionScope.account.url_avata != null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
